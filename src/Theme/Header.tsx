...
const LoginType = localStorage.getItem("isLogin");

import UserOne from "/src/Images/Employee/ProfilePic/1.png";
import Company from "/src/Images/Company/ProfilePic/1.png";
      ...
      <div className="flex flex-grow items-center justify-between px-4 py-4 shadow-2 md:px-6 2xl:px-11">
          ...
          >
            <span className="relative block h-5.5 w-5.5 cursor-pointer">
              <span className="du-block absolute right-0 h-full w-full">
                <span
                  className={`relative left-0 top-0 my-1 block h-0.5rounded-sm bg-black delay-[0] duration-200 ease-in-out dark:bg-white !w-full delay-300'
                }`}
                ></span>
                <span
                ...
                ></span>
                <span
                  className={`relative left-0 top-0 my-1 block h-0.5rounded-sm bg-black delay-200 duration-200 ease-in-out dark:bg-white !w-full delay-500'
                }`}
                ></span>
              </span>
              <span className="absolute right-0 h-full w-full rotate-45">
                <span
                  className={`absolute left-2.5 top-0 block  w-0.5 rounded-sm bg-black delay-300 duration-200 ease-in-out dark:bg-white !h-0 !delay-[0]'
                }`}
                ></span>
                <span
                  className={`delay-400 absolute left-0 top-2.5 block  w-full rounded-sm bg-black duration-200 ease-in-out dark:bg-white !h-0 !delay-200'
                }`}
                ></span>
              </span>
            </span>
        ...
        {!LoginType && (
          <div className="flex space-x-4 ">
            <div className="p-3 border border-employee hover:bg-employee ">
              <Link
                to="/employee/auth"
                className="ease-in-out text-slate-800 hover:text-white px-3 py-2 rounded-md text-sm font-medium dark:text-white dark:hover:text-employee"
              >
                User Portal
              </Link>
            </div>
            <div className="p-3 ">
              <Link
                to="/company/auth"
                className="duration-500 ease-in-out text-slate-800 hover:text-employee px-3 py-2 rounded-md text-sm font-medium dark:text-white dark:hover:text-employee"
              >
                Company Portal
              </Link>
            </div>
  ...
  return (
    <li className="relative">
      <Link
        ...
        to="#"
        className="relative flex h-8.5 w-8.5 items-center justify-center rounded-full border-[0.5px] border-stroke bg-gray hover:text-employee dark:border-strokedark dark:bg-meta-4 dark:text-white"
      >
        <span
        ...
        <ul className="flex h-auto flex-col overflow-y-auto">
          <li>
            ...
            >
              <div className="h-12.5 w-12.5 rounded-full">
                <img
                  src={`/src/Images/Employee/ProfilePic/2.png`}
          ...
          <li>
            ...
            >
              <div className="h-12.5 w-12.5 rounded-full">
                <img
                  src={`/src/Images/Employee/ProfilePic/3.png`}
                  className="rounded-full"
                  alt="User"
                />
              </div>
  ...
  return (
    <div className="relative">
      ...
      >
        {LoginType === "employee" && (
          <span className="hidden text-right lg:block text-black dark:text-white">
            <span className="block text-sm font-medium ">Danish Heilium</span>
        ...
        {LoginType === "company" && (
          <span className="hidden text-right lg:block text-black dark:text-white">
            <span className="block text-sm font-medium ">Hamro Patro</span>
          </span>
        )}
        ...
        <span className="h-12 w-12 rounded-full">
          {LoginType === "employee" && (
            <img
              src={UserOne}
              alt="User"
              className="h-12 w-12 rounded-full ml-auto object-cover"
            />
          )}
          {LoginType === "company" && (
            <img
      ...
      >
        <ul className="flex flex-col gap-5 border-b border-stroke px-6 py-7.5 dark:border-strokedark">
          <li>
            {LoginType === "employee" && (
              <Link
                to="employee/profile"
                className="flex items-center gap-3.5 text-sm font-medium duration-300 ease-in-out hover:text-employee lg:text-base"
              >
                <svg
        ...
        <button
          className="flex items-center gap-3.5 px-6 py-4 text-sm font-medium duration-300 ease-in-out hover:text-employee lg:text-base"
          onClick={logout}
        >
          <svg
            className="fill-current"
        ...
        {({ isActive }) => {
          return (
            <h4
              className={clsx(
                {
                  "bg-company  text-white": isActive,
                  "btn btn-link text-slate-400 hover:text-company after:bg-company duration-500 ease-in-out":
                    !isActive,
                },
                "p-3 py-2 rounded dark:text-gray mx-1"
              )}
            >
              {children}
            </h4>
        ...
        {({ isActive }) => {
          return (
            <h4
              className={clsx(
                {
                  "bg-employee  text-white": isActive,
                  "btn btn-link text-slate-400 hover:text-employee after:bg-employee duration-500 ease-in-out":
                    !isActive,
                },
                "p-2 pl-3 pb-1 rounded dark:text-gray mx-1"
              )}
            >
              {children}
            </h4>
...
const NavBar = () => {
  return LoginType === "company" ? (
    <div className="flex">
      <NavItem to={"/company/home"}>Dashboard</NavItem>
      <NavItem to={"/company/job"}>Jobs</NavItem>
      <NavItem to={"/company/employee"}>Employees</NavItem>
      <NavItem to={"/company/application/list"}>Applications</NavItem>
    </div>
  ) : (
    <div>
      <div className="flex">
        <NavItem to={"/employee/home"}>Home</NavItem>
        <NavItem to={"/employee/jobs/list"}>Jobs</NavItem>
        <NavItem to={"/employee/jobs/applied"}>Applied Jobs</NavItem>
      </div>
    </div>
  );
};
